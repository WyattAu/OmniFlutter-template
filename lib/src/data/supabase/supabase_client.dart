...
class SupabaseManager {
  ...
  Future<void> initialize() async {
    ...
    debugPrint('Environment variables - URL: ${supabaseUrl != null}, Key: ${supabaseAnonKey != null}');
    ...
    if (supabaseUrl == null || supabaseAnonKey == null) {
      ...
      try {
        ...
        debugPrint('Loaded from .env - URL: ${supabaseUrl != null}, Key: ${supabaseAnonKey != null}');
      } catch (e, stackTrace) {
    ...
    // Final check
    if (supabaseUrl == null || supabaseAnonKey == null) {
      debugPrint('Supabase credentials not found. Skipping Supabase initialization.');
